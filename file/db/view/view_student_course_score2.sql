DROP VIEW IF EXISTS view_student_course_score2;
CREATE VIEW `view_student_course_score2` AS
...
stu.id AS student_id, stu.student_no, stu.name AS student_name,score.score,score.id AS score_id
